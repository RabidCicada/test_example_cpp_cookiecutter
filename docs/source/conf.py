...
# build everything
package_name = "example_cpp_cookiecutter"
...
breathe_projects = { 'example_cpp_cookiecutter': '../xml/' }
...
exhale_args = {
    ...
    "rootFileName":          "example_cpp_cookiecutter_api.rst",
    "rootFileTitle":         "example_cpp_cookiecutter API",
...
breathe_default_project = 'example_cpp_cookiecutter'

templates_path = ['_template']
source_suffix = '.rst'
master_doc = 'index'
project = 'example_cpp_cookiecutter'
...
htmlhelp_basename = 'example_cpp_cookiecutter_doc'